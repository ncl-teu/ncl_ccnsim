...
1. In ccn.properties, please set `ccn_caching_no=0` to `ccn_caching_no=1`(i.e., increment it as the used index no). And please set `ccn_caching_allnum=1` to `ccn_caching_allnum=2` (i.e., increment it as the number of candidate caching algorithms). 
